        ...
        if st.button("🌐 Traduzir documento", type="primary"):
            try:
                ...
                if not original_text.strip():
                    st.error(
                        "Nenhum texto foi encontrado. Tente usar o modo 'Forçar OCR' ou envie uma imagem mais nítida."
                    )
                    st.stop()
...
# ============================================================
    ...
    render_section_title(
        "files",
        "Juntar PDFs",
        "Envie dois ou mais PDFs para gerar um arquivo único.",
        "#7C3AED"
    )
...
# ============================================================
    ...
    render_section_title(
        "scissors",
        "Dividir PDF",
        "Extraia um intervalo ou separe todas as páginas.",
        "#7C3AED"
    )
    ...
    if uploaded_file:
        try:
            ...
            mode = st.radio(
                "Modo de divisão",
                ["Extrair intervalo de páginas", "Separar todas as páginas"]
            )
...
# ============================================================
    ...
    render_section_title(
        ...
        "Extraia texto comum ou aplique OCR em PDFs escaneados.",
        "#7C3AED"
    )
...
# ============================================================
    ...
    render_section_title(
        ...
        "Extraia texto de documentos Word no formato DOCX.",
        "#2563EB"
    )
...
# ============================================================
    ...
    render_section_title(
        ...
        "Altere largura, altura, qualidade e formato final.",
        "#0891B2"
    )
...
# ============================================================
    ...
    render_section_title(
        ...
        "Envie uma ou mais imagens e gere um único PDF.",
        "#0891B2"
    )
...
# ============================================================
    ...
    render_section_title(
        ...
        "Conte palavras, limpe espaços e transforme texto rapidamente.",
        "#2563EB"
    )
...
# ============================================================
    ...
    render_section_title(
        "volume",
        "Texto para MP3",
        "Converta texto em áudio MP3 usando gTTS.",
        "#DC2626"
    )
